...
const CheckOut = () => {
    ...
    const {name, course_time,total_video,total_quiz,cost}=premium
    return (
      ...
      <Card.Body className='text-center'>
        <Card.Title className='fw-bold fs-3'>{cost}</Card.Title>
        <Card.Title>{name}</Card.Title>
        <Card.Title>Time:{course_time.time}</Card.Title>
        <Card.Title>Total Quiz: {total_quiz}</Card.Title>
        <Card.Title>Total videos: {total_video}</Card.Title>
      </Card.Body>
    </Card>
